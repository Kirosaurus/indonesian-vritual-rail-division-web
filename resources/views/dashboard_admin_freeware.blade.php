...
@section('title', 'Dashboard Admin Freeware')
...
@section('content')
    ...
    <div class="main-page-admin">
        ...
        <div class="container">
            <div class="top-card">
                <h2 class="page-title">Product Freeware</h2>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>database</td>
                        <td>
                            <a href="" class="edit"><img src="{{ asset('edit_icon.svg') }}" alt="Icon Edit" style="width: 30px; height: 30px; "></a>
                            <a href="" class="hapus"><img src="{{ asset('trash_icon.svg') }}" alt="Icon Trash" style="width: 30px; height: 30px; "></a>
                        </td>
                    </tr>
                </tbody>
            </table>
